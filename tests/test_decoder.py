...
class TestWeirdTextDecoder(TestCase):
    ...
    def test_original_words_attribute(self):
        expected_words = ['long', 'looong', 'sentence', 'some', 'test', 'This', 'with', 'words']
        self.assertEqual(self.decoder.original_words, expected_words)
        
    def test_check_if_middle_part_equal(self):
        original_word = 'word'
        permuted_word = 'wrod'
        self.assertTrue(self.decoder._check_if_middle_part_chars_equal(original_word,permuted_word))
        self.assertFalse(self.decoder._check_if_middle_part_chars_equal(original_word,"wood"))
    ...
    def test_decode(self):
        expected_text = 'This is a long looong test sentence,\nwith some big (biiiiig) words!'
